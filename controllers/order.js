...
const createAbandonedOrder = async (req, res) => {
  try {
...
module.exports = { createOrder, getAllOrders, getOrderById, getUserOrders, updateOrderStatus, deleteOrder, confirmOrder, createAbandonedOrder };