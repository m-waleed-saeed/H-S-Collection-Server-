...
// Get Two Random Banners
const getTwoRandomBanners = async (req, res) => {
  try {
    const banners = await Banner.find();
...
module.exports = { createBanner, deleteBanner, getAllBanner, getRandomBanner ,getTwoRandomBanners}